...
//
////////////////////////////////////////////////////////////////////////////
/*! \file HelmUtilityFunctions.h */


#ifndef HELM_UTILITY_FUNCTIONS_H
#define HELM_UTILITY_FUNCTIONS_H
...
inline void HelmAssert(bool condition)
{
  assert(condition);
}

inline void MOOSAssert(bool condition) { HelmAssert(condition); }
...
double HelmTime(bool bApplyTimeWarping=true);
...
double HPHelmTime(bool bApplyTimeWarping = true);
