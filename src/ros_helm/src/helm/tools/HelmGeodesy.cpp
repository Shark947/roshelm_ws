...
//
//////////////////////////    END_GPL    //////////////////////////////////
// HelmGeodesy.cpp: implementation of the HelmGeodesy class.
//
//////////////////////////////////////////////////////////////////////
...
bool HelmGeodesy::Initialise(double lat, double lon)
{
...
double HelmGeodesy::GetOriginLongitude()
{
    return m_dOriginLongitude;
}

double HelmGeodesy::GetOriginLatitude()
{
    return m_dOriginLatitude;    
}

void HelmGeodesy::SetOriginLongitude(double lon)
{
    m_dOriginLongitude = lon;
}

void HelmGeodesy::SetOriginLatitude(double lat)
{
    m_dOriginLatitude = lat;
}


double HelmGeodesy::GetMetersNorth()
{
    return m_dNorth;
}

double HelmGeodesy::GetMetersEast()
{
    return m_dEast;
}


bool HelmGeodesy::LLtoUTM(int ReferenceEllipsoid, const double Lat, 
...
char HelmGeodesy::UTMLetterDesignator(double Lat)
{
...
void HelmGeodesy::SetMetersNorth(double North)
{
    m_dNorth = North;
}

void HelmGeodesy::SetMetersEast(double East)
{
    m_dEast = East;
}

void HelmGeodesy::SetOriginNorthing(double North)
{
    m_dOriginNorthing = North;
}

void HelmGeodesy::SetOriginEasting(double East)
{
    m_dOriginEasting = East;
}

int HelmGeodesy::GetRefEllipsoid()
{
    return m_iRefEllipsoid;
}

void HelmGeodesy::SetRefEllipsoid(int refEllipsoid)
{
    m_iRefEllipsoid = refEllipsoid;
}

void HelmGeodesy::SetUTMZone(const char * utmZone)
{
    // Better hope the input string is no longer than 4...
    strcpy(m_sUTMZone, utmZone);
}

char * HelmGeodesy::GetUTMZone()
{
    return m_sUTMZone;
}
...
bool HelmGeodesy::LatLong2LocalUTM(double lat,
                                    double lon, 
                                    double &MetersNorth,
                                    double &MetersEast)
{
...
double HelmGeodesy::GetOriginEasting()
{
    return m_dOriginEasting;
}

double HelmGeodesy::GetOriginNorthing()
{
    return m_dOriginNorthing;
}

double HelmGeodesy::DMS2DecDeg(double dfVal)
{
...
bool HelmGeodesy::LatLong2LocalGrid(double lat, 
                                     double lon, 
                                     double &MetersNorth, 
                                     double &MetersEast)
{
...
void HelmGeodesy::SetLocalGridX(double X)
{
    m_dLocalGridX = X;
}

void HelmGeodesy::SetLocalGridY(double Y)
{
    m_dLocalGridY = Y;
}

double HelmGeodesy::GetLocalGridX()
{
    return m_dLocalGridX;
}

double HelmGeodesy::GetLocalGridY()
{
...
bool HelmGeodesy::LocalGrid2LatLong(double dfEast, double dfNorth, double &dfLat, double &dfLon) 
{
    //(semimajor axis)
    double dfa  = 6378137;
    // (semiminor axis)
...
bool HelmGeodesy::UTM2LatLong(double dfX, double dfY, double& dfLat, double& dfLong)
{
