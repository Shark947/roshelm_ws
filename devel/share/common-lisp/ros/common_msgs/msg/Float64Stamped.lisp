...
(cl:defmethod cl:initialize-instance :after ((m <Float64Stamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Float64Stamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name common_msgs-msg:<Float64Stamped> is deprecated: use common_msgs-msg:Float64Stamped instead.")))
